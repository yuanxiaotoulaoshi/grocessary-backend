...
export class GlossaryService {
  constructor(
    ...
    async create(createDto: CreateGlossaryDto) {
        const {cnName, enName, categoryLevel1,categoryLevel2,currentMetadata} = createDto;
    ...
    getCategoryTabs(){
        return {
            Collocations:['Noun+Noun','Adj+Noun','Verb+Noun','Adv+Adj','Verb+Adv','Verb+Prep','Noun+Verb','Idioms'],
